...
# Base模型 OOS指标
OOS_DIR = [70.2, 64.7, 62.2, 63.2, 65.8]
OOS_IC = [0.534, 0.388, 0.369, 0.379, 0.439]
OOS_AUC = [0.762, 0.704, 0.689, 0.688, 0.728]
TRAIN_ACC = [75.1, 78.8, 78.6, 77.0, 78.7]
TRAIN_OOS_GAP = [4.9, 14.1, 16.4, 13.9, 12.8]
...
VERSION_DATA = {
    ...
    'V6\n方向预测': {'top_f1': 0.177, 'bot_f1': 0.230, 'dir_acc': 65.2},
}
...
def chart41_horizon_metrics():
    ...
    fig.suptitle('V6 Base模型 OOS指标 (5个Horizon, 非重叠Walk-forward CV)',
